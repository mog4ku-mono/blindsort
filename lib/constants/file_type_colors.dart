...
/// swatch so a low-vision user can tell PDFs from slides at a glance before
/// TalkBack reads the name.
const Map<String, Color> kFileTypeColors = {
  ...
  'ZIP': Color(0xFF6D4C41),
};

/// Fallback when the extension is not in the map.
const Color kDefaultTypeColor = Color(0xFF546E7A);

/// Groups a file type under a broad category. Drives the category tiles on
/// Home and File Browser without a hardcoded switch inside each screen.
